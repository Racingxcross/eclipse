...
public class WeaponRunner {
	...
	public static void main(String[] args) {
		...
		Collection<WeaponDTO> dtos = Stream.of(dto, dto1, dto2, dto3, dto4, dto, dto1, dto2, dto3, dto4, dto5, dto6,
				dto7, dto8, dto9, dto10, dto11, dto12, dto13, dto14, dto15, dto16, dto17, dto18, dto19)
		...
		dtos.stream().sorted((a1, a2) -> a2.getName().compareTo(a1.getName()))
				.forEach(e -> System.out.println(e.getName()));

		System.out.println(System.lineSeparator());
		System.out.println("====weapons by price greater then====");
		dtos.stream().sorted((a1, a2) -> a1.getMadeBy().compareTo(a2.getMadeBy()))
				.forEach(e -> System.out.println(e.getMadeBy()));

		System.out.println(System.lineSeparator());
		System.out.println("===sortedBy madeOn=====");
		dtos.stream().sorted((a1, a2) -> a1.getMadeOn().compareTo(a2.getMadeOn()))
				.forEach(e -> System.out.println(e.getMadeOn()));

		System.out.println(System.lineSeparator());
		System.out.println("====price ascending======");
		dtos.stream().sorted((a1, a2) -> Double.compare(a1.getPrice(), a2.getPrice()))
				.forEach(e -> System.out.println(e.getPrice()));

		System.out.println(System.lineSeparator());
		System.out.println("====price descending =====");
		dtos.stream().sorted((a1, a2) -> Double.compare(a2.getPrice(), a1.getPrice()))
				.forEach(e -> System.out.println(e.getPrice()));

		System.out.println(System.lineSeparator());
		System.out.println("====sort by madeOn and name asc order=====");
		dtos.stream().sorted((a1, a2) -> a1.getName().compareTo(a2.getName()))
				.forEach(e -> System.out.println(e.getName()));
		dtos.stream().sorted((a1, a2) -> a1.getMadeOn().compareTo(a2.getMadeOn()))
				.forEach(e -> System.out.println(e.getMadeOn()));
		...
		dtos.stream().sorted((a1, a2) -> a2.getType().compareTo(a1.getType()))
				.forEach(e -> System.out.println(e.getType()));
		dtos.stream().sorted((a1, a2) -> a2.getMadeBy().compareTo(a2.getMadeBy()))
				.forEach(e -> System.out.println(e.getMadeBy()));
