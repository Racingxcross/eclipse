...
public Car(String name, int cc, int topSpeed, String[] color, int[] RPM, int[] noOfGears, int[] model, int[] mialage, boolean discBrake, boolean offRoad, char bikeLength, double fuelCapacity) {
	this.name=name;
	this.cc=cc;
